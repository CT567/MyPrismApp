...
namespace PrismDemo.Services.Motion.LeiSai //命名空间根据应用程序修改
{
    ...
    public delegate uint DMC3K5K_OPERATE(nint operate_data);
    public partial class LTDMC
    {
        ...
        public static extern short dmc_get_debug_mode(ref ushort mode, nint FileName);
        //---------------------   板卡初始和配置函数  ----------------------
        //初始化控制卡（适用于所有脉冲/总线卡）
        ...
        **************************************************************/
        ...
        //开启控制卡中断功能
        [DllImport("LTDMC.dll")]
        public static extern uint dmc_int_enable(ushort CardNo, DMC3K5K_OPERATE funcIntHandler, nint operate_data);
        //禁止控制卡的中断
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_profile_extern(ushort CardNo, ushort axis, double Min_Vel, double Max_Vel, double Tacc, double Tdec, double Ajerk, double Djerk, double stop_vel);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_profile_extern(ushort CardNo, ushort axis, ref double Min_Vel, ref double Max_Vel, ref double Tacc, ref double Tdec, ref double Ajerk, ref double Djerk, ref double stop_vel);

        [DllImport("LTDMC.dll")]
        public static extern short dmc_conti_delay_pwm_to_stop(ushort CardNo, ushort Crd, ushort pwmno, ushort on_off, double delay_time, double ReverseTime);


        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_profile_limit(ushort CardNo, ushort axis, double Max_Vel, double Max_Acc, double EvenTime);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_profile_limit(ushort CardNo, ushort axis, ref double Max_Vel, ref double Max_Acc, ref double EvenTime);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_vector_profile_limit(ushort CardNo, ushort Crd, double Max_Vel, double Max_Acc, double EvenTime);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_vector_profile_limit(ushort CardNo, ushort Crd, ref double Max_Vel, ref double Max_Acc, ref double EvenTime);
        ...
        //1、	启用缓存方式添加比较位置：
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_set_mode(ushort CardNo, ushort hcmp, ushort fifo_mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_get_mode(ushort CardNo, ushort hcmp, ref ushort fifo_mode);
        //2、	读取剩余缓存状态，上位机通过此函数判断是否继续添加比较位置
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_get_state(ushort CardNo, ushort hcmp, ref long remained_points);
        //3、	按数组的方式批量添加比较位置
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_add_point_unit(ushort CardNo, ushort hcmp, ushort num, double[] x_cmp_pos, double[] y_cmp_pos, ushort[] cmp_outbit);
        //4、	清除比较位置,也会把FPGA的位置同步清除掉
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_clear_points(ushort CardNo, ushort hcmp);
        //添加大数据，会堵塞一段时间，指导数据添加完成
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_add_table(ushort CardNo, ushort hcmp, ushort num, double[] x_cmp_pos, double[] y_cmp_pos);



        //门运动
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_unit(ushort CardNo, ushort Crd, ushort axis_num, ushort[] axis_list, double[] mid_pos, double[] target_pos, double[] saftpos, ushort pos_mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_m_move_config(ushort CardNo, ushort Crd, ref ushort axis_num, ushort[] axis_list, double[] mid_pos, double[] target_pos, double[] saftpos, ref ushort pos_mode);


        [DllImport("LTDMC.dll")]
        public static extern short nmc_write_to_pci(ushort CardNo, ushort PortNum, ushort NodeNum);


        //TypeIndex:0~6  m_Averagetime ; 平均时间 m_Maxtime;最大时间 uint64  m_Cycles;当前时间
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_perline_time(ushort CardNo, ushort TypeIndex, ref int Averagetime, ref int Maxtime, ref ulong Cycles);



        [DllImport("LTDMC.dll")]
        public static extern short nmc_set_axis_contrlmode(ushort CardNo, ushort Axis, long Contrlmode);
        [DllImport("LTDMC.dll")]
        public static extern short nmc_get_axis_contrlmode(ushort CardNo, ushort Axis, ref long Contrlmode);



        // 获取控制卡错误码
        [DllImport("LTDMC.dll")]
        public static extern short nmc_get_card_errcode(ushort CardNo, ref ushort Errcode);
        // 清除控制卡错误码
        [DllImport("LTDMC.dll")]
        public static extern short nmc_clear_card_errcode(ushort CardNo);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short nmc_get_log(ushort CardNo, ushort chan, ushort node, ref uint data);


        //新版门运动
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_set_coodinate(ushort card, ushort liner, ushort axis_num, ushort[] axis_list, uint in_io_num, ushort trig_flag, ushort pos_mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_get_coodinate_para(ushort card, ushort liner, ref ushort axis_num, ushort[] axis_list, ref uint in_io_num, ref ushort trig_flag, ref ushort pos_mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_set_z_para(ushort card, ushort liner, double z_up_safe_pos, double z_up_target_pos, double z_down_safe_pos, double z_down_target_pos);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_get_z_para(ushort card, ushort liner, ref double z_up_safe_pos, ref double z_up_target_pos, ref double z_down_safe_pos, ref double z_down_target_pos);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_set_xy_para(ushort card, ushort liner, double x_first_safe_pos, double x_second_safe_pos, double x_target_pos, ushort y_num, double[] y_target_pos);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_get_xy_para(ushort card, ushort liner, ref double x_first_safe_pos, ref double x_second_safe_pos, ref double x_target_pos, ushort y_num, double[] y_target_pos);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_axes(ushort card, ushort liner);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_get_run_phase(ushort card, ushort liner, ref ushort run_phase);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_move_stop(ushort card, ushort liner, ushort stop_mode);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cmd_buf_get_group_run_info(ushort CardNo, ushort group, ref ushort enable, ref uint array_id, ref uint stop_reason, ref ushort trig_phase, ref ushort phase);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cmd_buf_add_cmd(ushort CardNo, ushort group, uint index, ushort cmd_type, ushort ProcessMode, ushort Dim, ushort[] AxisList, double[] TargetPositionFirst,
            ...
            ushort m_TrigIONum, ushort[] m_TrigIOState, ushort[] m_TrigINIOList, uint m_DelayCmdTime, ushort m_IOList, ushort m_IOState, ushort m_TrigError);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_add_posTrig_torque_movseg_data(ushort CardNo, ushort group, ushort axis, double torque, double PosLimitValue, ushort PosLimitValid, ushort PosMode, ushort trigAxis, double trigPos, ushort trigPosType, ushort trigMode, uint mark);//位置触发转矩移动
       ...
       **********************************************************/
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_message_buffer_enable(ushort CardNo, ushort index, uint buffer_size, byte console_enable);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_message_buffer_disable(ushort CardNo, ushort index);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_message_buffer_get_data(ushort CardNo, ushort index, long bufsize, ref byte data, ref uint pbufsize);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_t_pmove_extern_softstart(ushort CardNo, ushort axis, double MidPos, double TargetPos, double start_Vel, double Max_Vel, double stop_Vel, uint delay_ms, double Max_Vel2, double stop_vel2, double acc_time, double dec_time, ushort posi_mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_t_pmove_extern_softstart_unit(ushort CardNo, ushort axis, double MidPos, double TargetPos, double start_Vel, double Max_Vel, double stop_Vel, uint delay_ms, double Max_Vel2, double stop_vel2, double acc_time, double dec_time, ushort posi_mode);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_pvt_table_continuous(ushort CardNo, ushort axis, uint count, double[] pos, double[] vel, double[] percent, double[] vel_max, double[] acc, double[] dec);
        //根据传入的参数，获取各个位置节点的时间
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_conti_clear_node_io_action(ushort CardNo, ushort Crd, ushort node_ID, uint Io_Mask);
        [DllImport("LTDMC.dll")]
        ...
        *********************************************************************************************************/
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_table_unit(ushort CardNo, ushort MasterAxisNo, ushort SlaveAxisNo, uint Count, double[] pMasterPos, double[] pSlavePos, ushort SrcMode);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_cam_out_status(ushort CardNo, ushort slave_axis, ref ushort done, ref ushort busy, ref ushort cmd_aborted, ref ushort error, ref uint error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_read_points(ushort CardNo, ushort execute, ushort cam_table, ushort cam_chg_point, uint cam_point_num, ushort[] done, ushort[] busy, ushort[] error, uint[] error_id, ref double master_pos, ref double slave_pos, ref double slave_vel, ref double slave_acc);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_write_points(ushort CardNo, ushort execute, ushort cam_table, uint cam_point_num, double master_pos, double slave_pos, double slave_vel, double slave_acc, ushort[] done, ushort[] busy, ushort[] error, uint[] error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_set(ushort CardNo, ushort execute, ushort cam_table, ushort[] done, ushort[] busy, ushort[] error, uint[] error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_read_tappet_status(ushort CardNo, ushort execute, ushort cam_table, uint tappet_num1, uint tappet_num2, uint tappet_num3, uint tappet_num4, uint tappet_num5, uint tappet_num6, uint tappet_num7, uint tappet_num8, ref ushort valid, ref ushort busy, ref ushort error, ref uint error_id, ref ushort status1, ref ushort status2, ref ushort status3, ref ushort status4, ref ushort status5, ref ushort status6, ref ushort status7, ref ushort status8);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_read_tappet_value(ushort CardNo, ushort execute, ushort cam_table, uint tappet_num, ref ushort valid, ref ushort busy, ref ushort error, ref uint error_id, ref double master_pos, ref ushort positive_mode, ref ushort negative_mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_write_tappet_value(ushort CardNo, ushort execute, ushort cam_table, uint tappet_num, double master_pos, ushort positive_mode, ushort negative_mode, ushort[] done, ushort[] busy, ushort[] error, uint[] error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_add_tappet(ushort CardNo, ushort execute, ushort cam_table, double master_pos, ushort positive_mode, ushort negative_mode, ushort[] done, ushort[] busy, ushort[] error, uint[] error_id, uint[] tappet_num);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cam_delete_tappet(ushort CardNo, ushort execute, ushort cam_table, ushort[] done, ushort[] busy, ushort[] error, uint[] error_id);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_mc_gearin_status(ushort CardNo, ushort slave_axis, ref ushort in_gear, ref ushort busy, ref ushort active, ref ushort cmd_aborted, ref ushort error, ref uint error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_mc_gear_out(ushort CardNo, ushort slave_axis, ushort[] execute);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_mc_gear_out_status(ushort CardNo, ushort slave_axis, ref ushort done, ref ushort busy, ref ushort cmd_aborted, ref ushort error, ref uint error_id);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_mc_combine_axes_status(ushort CardNo, ushort slave_axis, ref ushort in_sync, ref ushort busy, ref ushort active, ref ushort cmd_aborted, ref ushort error, ref uint error_id);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_apf_rotary_cut_init(ushort CardNo, uint rotary_cut_id, ushort execute, double rotary_axis_radius, uint rotary_axis_knife_num, double feed_axis_radius, double cutlength, double sync_start_pos, double sync_stop_pos, double rot_start_pos, double fed_stop_pos);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_apf_rotary_cut_init(ushort CardNo, uint rotary_cut_id, ref ushort execute, ref double rotary_axis_radius, ref uint rotary_axis_knife_num, ref double feed_axis_radius, ref double cutlength, ref double sync_start_pos, ref double sync_stop_pos, ref double rot_start_pos, ref double fed_stop_pos);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_apf_rotary_cut_init_status(ushort CardNo, uint rotary_cut_id, ref ushort done, ref ushort busy, ref ushort error, ref uint error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_apf_rotary_cut_in(ushort CardNo, uint rotary_cut_id, ushort execute, ushort rotary_axis, ushort feed_axis);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_apf_rotary_cut_in_status(ushort CardNo, uint rotary_cut_id, ref ushort done, ref ushort busy, ref ushort error, ref uint error_id);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_apf_rotary_cut_in(ushort CardNo, uint rotary_cut_id, ref ushort execute, ref ushort rotary_axis, ref ushort feed_axis);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_apf_rotary_cut_out(ushort CardNo, uint rotary_cut_id, ushort execute, ushort rotary_axis);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_apf_rotary_cut_out_status(ushort CardNo, uint rotary_cut_id, ref ushort done, ref ushort busy, ref ushort error, ref uint error_id);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_timeout(ushort CardNo, uint timems);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_mc_gear_in_pos_status(ushort CardNo, ushort slave_axis, ref ushort start_sync, ref ushort in_sync, ref ushort busy, ref ushort active, ref ushort cmd_aborted, ref ushort error, ref uint error_id);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short nmc_set_etc_el_stop_mode(ushort CardNo, ushort axis, ushort el_control_mode, double diff_pos, uint filter);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_t_pmove_extern_dectime(ushort CardNo, ushort axis, uint dec_time);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_t_pmove_extern_dectime(ushort CardNo, ushort axis, ref uint dec_time);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_sine_oscillate_set_cycle_num(ushort CardNo, ushort Axis, uint cycle_num);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_sine_oscillate_get_cycle_num(ushort CardNo, ushort Axis, ref uint cycle_num);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_pvt_get_run_index(ushort CardNo, ushort axis, ref uint index);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_emg_lock(ushort CardNo, ushort enable, ushort bit_no, ushort level, int out_mark, int out_level);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_emg_lock(ushort CardNo, ref ushort enable, ref ushort bit_no, ref ushort level, ref int out_mark, ref int out_level);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_check_done_multicoor_extern(ushort CardNo, ushort Crd, ref ushort crd_state, ref uint crd_stop_reason, ref uint axis_stop_reason);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_error_description(int errcocode, byte[] description);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_write_outport_mask(ushort CardNo, ushort port, uint mask, uint state, uint reverse_time_ms);



        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_pso_output_delay(ushort CardNo, ushort axis, uint delay_cycle);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_pso_output_delay(ushort CardNo, ushort axis, ref uint delay_cycle);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_mc_phasing_status(ushort CardNo, ushort slave_axis, ref ushort done, ref ushort busy, ref ushort cmd_aborted, ref ushort error, ref uint error_id);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_add_sigaxis_moveseg_data_ex(ushort CardNo, ushort group, ushort Axis, double Target_pos, uint mark);
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_add_trigger_data(ushort CardNo, ushort group, ushort mode, ushort num, double Target_Value, uint mark);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_add_time_delay(ushort CardNo, ushort group, double Time_delay, uint mark);
